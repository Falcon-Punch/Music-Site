...
function setRepeat()
{
	...
	$(".controlButton.repeat img").attr("src", "assets/images/icons/UV/" + imageName);
}
...
function setShuffle()
{
	...
	$(".controlButton.shuffle img").attr("src", "assets/images/icons/UV/" + imageName);
...
function setMute()
{
	...
	$(".controlButton.volume img").attr("src", "assets/images/icons/UV/" + imageName);
}
